...
| Project | What it is |
|---|---|
| [cmtraceopen](https://github.com/adamgell/cmtraceopen) | Free, open-source CMTrace replacement — ConfigMgr/Intune/Autopilot log analysis on Windows, macOS, and Linux |
| [GraphKit](https://github.com/adamgell/GraphKit) | Query Microsoft Graph across multiple tenants from PowerShell — auth, retries, throttling, and paging handled for you |
| [TenantPulse](https://github.com/adamgell/TenantPulse) | Read-only Intune/Entra tenant health assessment with deterministic, pseudonymized findings |
| [ProxmoxVEAutopilot](https://github.com/adamgell/ProxmoxVEAutopilot) | Turns a Proxmox VE node into a browser-managed Windows deployment lab |
| [device-cleanup-automation](https://github.com/adamgell/device-cleanup-automation) | Terraform-provisioned Azure Automation for two-stage stale-device cleanup |
